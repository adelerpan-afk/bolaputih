  ...
  var CopyPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        } else if (renderer.outputEncoding === import_three25.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three25.sRGBEncoding;
        }
      }
    }
  };
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three27.UnsignedByteType) {
          this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        } else if (renderer.outputEncoding === import_three27.sRGBEncoding) {
          this.renderTargetA.texture.encoding = import_three27.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three27.sRGBEncoding;
        }
      }
    }
  };
...
`;
      ...
      if (mainImageExists) {
        if (effect.inputColorSpace !== null && effect.inputColorSpace !== data.colorSpace) {
          fragmentMainImage += effect.inputColorSpace === import_three35.sRGBEncoding ? "color0 = LinearTosRGB(color0);\n	" : "color0 = sRGBToLinear(color0);\n	";
        }
...
`;
  ...
  var EffectPass = class extends Pass {
    ...
    updateMaterial() {
      ...
      if (data.colorSpace === import_three35.sRGBEncoding) {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three36.UnsignedByteType) {
          ...
          this.renderTargetA.texture.encoding = import_three36.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three36.sRGBEncoding;
        }
      }
    }
  };
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three37.UnsignedByteType) {
          this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
          this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
        } else if (renderer.outputEncoding === import_three37.sRGBEncoding) {
          this.renderTargetA.texture.encoding = import_three37.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three37.sRGBEncoding;
        }
      }
    }
    static get AUTO_SIZE() {
  ...
  var MipmapBlurPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        } else if (renderer.outputEncoding === import_three39.sRGBEncoding) {
          for (const mipmap of mipmaps) {
            mipmap.texture.encoding = import_three39.sRGBEncoding;
          }
        }
      }
    }
  ...
  var EffectComposer = class {
    ...
    setRenderer(renderer) {
      ...
      if (renderer !== null) {
        ...
        if (frameBufferType === import_three42.UnsignedByteType && renderer.outputEncoding === import_three42.sRGBEncoding) {
          this.inputBuffer.texture.encoding = import_three42.sRGBEncoding;
          this.outputBuffer.texture.encoding = import_three42.sRGBEncoding;
          this.inputBuffer.dispose();
          this.outputBuffer.dispose();
        }
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      ...
      let renderTarget;
      if (multisampling > 0) {
        renderTarget = Number(import_three42.REVISION.replace(/\D+/g, "")) < 138 ? new import_three42.WebGLMultisampleRenderTarget(size.width, size.height, options) : new import_three42.WebGLRenderTarget(size.width, size.height, options);
        renderTarget.ignoreDepthForMultisampleCopy = false;
        renderTarget.samples = multisampling;
      } else {
        renderTarget = new import_three42.WebGLRenderTarget(size.width, size.height, options);
      }
      if (type === import_three42.UnsignedByteType && renderer !== null && renderer.outputEncoding === import_three42.sRGBEncoding) {
        renderTarget.texture.encoding = import_three42.sRGBEncoding;
      }
  ...
  var EffectShaderData = class {
    constructor() {
      ...
      this.colorSpace = import_three43.LinearEncoding;
    }
  };
  ...
  var BlendMode = class extends import_three44.EventDispatcher {
    constructor(blendFunction, opacity = 1) {
      super();
      this._blendFunction = blendFunction;
      this.opacity = new import_three44.Uniform(opacity);
    }
    getOpacity() {
  ...
  var Effect = class extends import_three45.EventDispatcher {
    constructor(name, fragmentShader, {
      ...
      this._inputColorSpace = import_three45.LinearEncoding;
    ...
    setDepthTexture(depthTexture, depthPacking = import_three45.BasicDepthPacking) {
    }
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        const property = this[key];
        const isDisposable = property instanceof import_three45.WebGLRenderTarget || property instanceof import_three45.Material || property instanceof import_three45.Texture || property instanceof Pass;
        if (isDisposable) {
          this[key].dispose();
        }
      }
  ...
  var BloomEffect = class extends Effect {
    constructor({
      ...
      super("BloomEffect", bloom_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["map", new import_three46.Uniform(null)],
          ["intensity", new import_three46.Uniform(intensity)]
        ])
      });
      this.renderTarget = new import_three46.WebGLRenderTarget(1, 1, { depthBuffer: false });
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
        if (renderer.outputEncoding === import_three46.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three46.sRGBEncoding;
        }
      }
    }
  };
    ...
    constructor({
      ...
      super("BokehEffect", bokeh_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["dof", new import_three47.Uniform(dof)],
          ["aperture", new import_three47.Uniform(aperture)],
  ...
  var BrightnessContrastEffect = class extends Effect {
    constructor({ blendFunction = BlendFunction.SRC, brightness = 0, contrast = 0 } = {}) {
      super("BrightnessContrastEffect", brightness_contrast_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["brightness", new import_three48.Uniform(brightness)],
          ["contrast", new import_three48.Uniform(contrast)]
        ])
      });
      this.inputColorSpace = import_three48.sRGBEncoding;
    }
    get brightness() {
  ...
  var ColorDepthEffect = class extends Effect {
    constructor({ blendFunction, bits = 16 } = {}) {
      super("ColorDepthEffect", color_depth_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["factor", new import_three49.Uniform(1)]
        ])
      });
      this.bits = 0;
      this.bitDepth = bits;
  ...
  var ChromaticAberrationEffect = class extends Effect {
    constructor({
      offset = new import_three50.Vector2(1e-3, 5e-4),
      ...
      super("ChromaticAberrationEffect", chromatic_aberration_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["offset", new import_three50.Uniform(offset)],
          ["modulationOffset", new import_three50.Uniform(modulationOffset)]
        ])
      });
  ...
  var DepthOfFieldEffect = class extends Effect {
    constructor(camera, {
      ...
      super("DepthOfFieldEffect", depth_of_field_default, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: /* @__PURE__ */ new Map([
          ["nearColorBuffer", new import_three51.Uniform(null)],
          ["farColorBuffer", new import_three51.Uniform(null)],
          ["nearCoCBuffer", new import_three51.Uniform(null)],
          ["scale", new import_three51.Uniform(1)]
        ])
      });
      this.camera = camera;
      this.renderTarget = new import_three51.WebGLRenderTarget(1, 1, { depthBuffer: false });
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputEncoding === import_three51.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three51.sRGBEncoding;
          this.renderTargetNear.texture.encoding = import_three51.sRGBEncoding;
          this.renderTargetFar.texture.encoding = import_three51.sRGBEncoding;
          this.renderTargetMasked.texture.encoding = import_three51.sRGBEncoding;
        }
      }
    }
  };
  ...
  var DotScreenEffect = class extends Effect {
    constructor({ blendFunction, angle = Math.PI * 0.5, scale = 1 } = {}) {
      super("DotScreenEffect", dot_screen_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["angle", new import_three52.Uniform(new import_three52.Vector2())],
          ["scale", new import_three52.Uniform(scale)]
        ])
      });
      this.angle = angle;
    }
  ...
  var GammaCorrectionEffect = class extends Effect {
    constructor({ blendFunction = BlendFunction.SRC, gamma = 2 } = {}) {
      super("GammaCorrectionEffect", gamma_correction_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["gamma", new import_three53.Uniform(gamma)]
        ])
      });
    }
  };
  ...
  function getNoise(size, format, type) {
    const channels = /* @__PURE__ */ new Map([
      [import_three54.LuminanceFormat, 1],
      [import_three54.RedFormat, 1],
      [import_three54.RGFormat, 2],
      [import_three54.RGBAFormat, 4]
    ]);
    let data;
    if (!channels.has(format)) {
      console.error("Invalid noise texture format");
    }
    if (type === import_three54.UnsignedByteType) {
  ...
  var NoiseTexture = class extends import_three54.DataTexture {
    constructor(width, height, format = import_three54.LuminanceFormat, type = import_three54.UnsignedByteType) {
  ...
  var GlitchEffect = class extends Effect {
    constructor({
      ...
      delay = new import_three55.Vector2(1.5, 3.5),
      duration = new import_three55.Vector2(0.6, 1),
      strength = new import_three55.Vector2(0.3, 1),
      columns = 0.05,
      ratio = 0.85,
      ...
      super("GlitchEffect", glitch_default, {
        uniforms: /* @__PURE__ */ new Map([
          ["perturbationMap", new import_three55.Uniform(null)],
          ["columns", new import_three55.Uniform(columns)],
          ["active", new import_three55.Uniform(false)],
          ["random", new import_three55.Uniform(1)],
          ["seeds", new import_three55.Uniform(new import_three55.Vector2())],
          ["distortion", new import_three55.Uniform(new import_three55.Vector2())]
        ])
      });
      if (perturbationMap === null) {
        const map = new NoiseTexture(dtSize, dtSize, import_three55.RGBAFormat);
        map.name = textureTag;
      ...
      this.breakPoint = new import_three55.Vector2(
    ...
    set perturbationMap(value) {
      ...
      value.minFilter = value.magFilter = import_three55.NearestFilter;
      value.wrapS = value.wrapT = import_three55.RepeatWrapping;
    ...
    generatePerturbationMap(value = 64) {
      const map = new NoiseTexture(value, value, import_three55.RGBAFormat);
      map.name = textureTag;
      return map;
    }
    update(renderer, inputBuffer, deltaTime) {
  ...
  // src/effects/GodRaysEffect.js
  var v = new import_three56.Vector3();
  var m = new import_three56.Matrix4();
  var GodRaysEffect = class extends Effect {
    constructor(camera, lightSource, {
      ...
      super("GodRaysEffect", god_rays_default, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: /* @__PURE__ */ new Map([
          ["map", new import_three56.Uniform(null)]
        ])
      });
      this.camera = camera;
      ...
      this.lightScene = new import_three56.Scene();
      this.screenPosition = new import_three56.Vector2();
      this.renderTargetA = new import_three56.WebGLRenderTarget(1, 1, { depthBuffer: false });
      this.renderTargetA.texture.name = "GodRays.Target.A";
      this.renderTargetB = this.renderTargetA.clone();
      this.renderTargetB.texture.name = "GodRays.Target.B";
      this.uniforms.get("map").value = this.renderTargetB.texture;
      this.renderTargetLight = new import_three56.WebGLRenderTarget(1, 1);
      this.renderTargetLight.texture.name = "GodRays.Light";
      this.renderTargetLight.depthTexture = new import_three56.DepthTexture();
      this.renderPassLight = new RenderPass(this.lightScene, camera);
      this.renderPassLight.clearPass.overrideClearColor = new import_three56.Color(0);
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputEncoding === import_three56.sRGBEncoding) {
          this.renderTargetA.texture.encoding = import_three56.sRGBEncoding;
          this.renderTargetB.texture.encoding = import_three56.sRGBEncoding;
          this.renderTargetLight.texture.encoding = import_three56.sRGBEncoding;
        }
      }
    }
  };
  ...
  var GridEffect = class extends Effect {
    constructor({ blendFunction = BlendFunction.OVERLAY, scale = 1, lineWidth = 0 } = {}) {
      super("GridEffect", grid_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["scale", new import_three57.Uniform(new import_three57.Vector2())],
          ["lineWidth", new import_three57.Uniform(lineWidth)]
        ])
      });
  ...
  var HueSaturationEffect = class extends Effect {
    constructor({ blendFunction = BlendFunction.SRC, hue = 0, saturation = 0 } = {}) {
      super("HueSaturationEffect", hue_saturation_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["hue", new import_three58.Uniform(new import_three58.Vector3())],
          ["saturation", new import_three58.Uniform(saturation)]
        ])
      });
      this.hue = hue;
    }
  ...
  var LUT1DEffect = class extends Effect {
    constructor(lut, { blendFunction = BlendFunction.SRC } = {}) {
      super("LUT1DEffect", lut_1d_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([["lut", new import_three59.Uniform(null)]])
      });
      this.lut = lut;
    }
    get lut() {
    ...
    set lut(value) {
      ...
      if (value !== null && (value.type === import_three59.FloatType || value.type === import_three59.HalfFloatType)) {
  ...
  // src/textures/lut/LookupTexture.js
  var c = new import_three60.Color();
  var LookupTexture = class extends import_three60.DataTexture3D {
    constructor(data, size) {
      super(data, size, size, size);
      this.type = import_three60.FloatType;
      this.format = import_three60.RGBAFormat;
      this.encoding = import_three60.LinearEncoding;
      this.minFilter = import_three60.LinearFilter;
      this.magFilter = import_three60.LinearFilter;
      this.wrapS = import_three60.ClampToEdgeWrapping;
      this.wrapT = import_three60.ClampToEdgeWrapping;
      this.wrapR = import_three60.ClampToEdgeWrapping;
      this.unpackAlignment = 1;
      this.needsUpdate = true;
      this.domainMin = new import_three60.Vector3(0, 0, 0);
      this.domainMax = new import_three60.Vector3(1, 1, 1);
    }
    ...
    applyLUT(lut) {
      ...
      } else if (lut.type !== import_three60.FloatType || this.type !== import_three60.FloatType) {
        console.error("Both LUTs must be FloatType textures");
      } else if (lut.format !== import_three60.RGBAFormat || this.format !== import_three60.RGBAFormat) {
    ...
    convertToUint8() {
      if (this.type === import_three60.FloatType) {
        ...
        this.type = import_three60.UnsignedByteType;
        this.needsUpdate = true;
      }
      return this;
    }
    convertToFloat() {
      if (this.type === import_three60.UnsignedByteType) {
    ...
    convertLinearToSRGB() {
      ...
      if (this.type === import_three60.FloatType) {
        ...
        this.encoding = import_three60.sRGBEncoding;
        this.needsUpdate = true;
      } else {
    ...
    toDataTexture() {
      ...
      const texture = new import_three60.DataTexture(this.image.data, width, height);
      texture.name = this.name;
      texture.type = this.type;
      texture.format = this.format;
      texture.encoding = this.encoding;
      texture.minFilter = import_three60.LinearFilter;
      texture.magFilter = import_three60.LinearFilter;
    ...
    generate() {
      ...
      return promise.then((urls) => {
        return new Promise((resolve, reject) => {
          ...
          const manager = new import_three61.LoadingManager();
  ...
  var LUT3DEffect = class extends Effect {
    ...
    set lut(value) {
      ...
      if (this.lut !== value) {
        ...
        if (value !== null) {
          ...
          } else if (value instanceof import_three62.DataTexture3D) {
    ...
    updateScaleOffset() {
      ...
      if (lut !== null) {
        ...
        if (this.tetrahedralInterpolation && lut instanceof import_three62.DataTexture3D) {
    ...
    configureTetrahedralInterpolation() {
      ...
      if (lut !== null) {
        ...
        if (this.tetrahedralInterpolation) {
          if (lut instanceof import_three62.DataTexture3D) {
  ...
  var v2 = new import_three67.Vector3();
  var ab = new import_three67.Vector3();
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTargetMasked.texture.type = frameBufferType;
        if (renderer.outputEncoding === import_three68.sRGBEncoding) {
          this.renderTargetMasked.texture.encoding = import_three68.sRGBEncoding;
        }
      }
    }
  };
  ...
  var TiltShiftEffect = class extends Effect {
    constructor({
      ...
      super("TiltShiftEffect", tilt_shift_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["maskParams", new import_three73.Uniform(new import_three73.Vector4())],
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
        if (renderer.outputEncoding === import_three73.sRGBEncoding) {
          this.renderTarget.texture.encoding = import_three73.sRGBEncoding;
        }
      }
    }
  };
